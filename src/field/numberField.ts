 ...
 *
 * const age = new NumberField.Builder("Age")
...
export class NumberField {
  ...
  readonly #defaultValue: O.Option<number>;
  readonly #computeFn: O.Option<(value: Nullable<number>) => number>;
  readonly #validateFn: O.Option<(value: Nullable<number>) => void | Message>;
  ...
  static Builder = class NumberFieldBuilder implements IBuilder<NumberField> {
    readonly #label: string;
    #description?: string;
    #isRequired?: boolean;
    #isReadOnly?: boolean;
